...
@st.cache_resource
def cargar_modelo():
    model    = joblib.load("LR/vigiax_lr_model.pkl")
    scaler   = joblib.load("LR/vigiax_scaler.pkl")
    encoder  = joblib.load("LR/vigiax_encoder.pkl")
    features = joblib.load("LR/vigiax_features.pkl")
